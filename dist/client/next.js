...
var _window = window,
    ...
    paramRoutes = _window$__NEXT_DATA__.paramRoutes;


var App = app ? (0, _evalScript2.default)(app).default : _app2.default;
var Component = (0, _evalScript2.default)(component).default;

var router = exports.router = new _router2.default(window.location.href, { Component: Component, ctx: { err: err, paramRoutes: paramRoutes } });
