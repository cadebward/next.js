...
var Router = function () {
  ...
  (0, _createClass3.default)(Router, [{
    ...
    value: function onPopState(e) {
      ...
      var route = (e.state || {}).route || toRoute(window.location.pathname);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (!(route !== _this.route)) {
                  _context.next = 8;
                  break;
                }

                _context.next = 7;
                return _this.getInitialProps(data.Component, data.ctx);
              ...
              case 8:
                ...
                _this.route = toRoute(route, _this.paramRoutes);
    ...
    key: 'update',
    value: function update(_route, Component) {
      var route = toRoute(_route, this.paramRoutes);
    ...
    key: 'reload',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(_route) {
        var route, data, props;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                route = toRoute(_route, this.paramRoutes);
              ...
              case 9:
                ...
                _context2.next = 13;
                return this.getInitialProps(data.Component, data.ctx);
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!route) route = toRoute((0, _url.parse)(url).pathname);
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(url) {
        ...
        var _route, route, data;

        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _route = toRoute((0, _url.parse)(url).pathname);
                route = toRoute(_route, this.paramRoutes);
                          ...
                          return new _promise2.default(function (resolve, reject) {
                            ...
                            var xhr = loadComponent(componentUrl, function (err, data) {
                              ...
                              resolve({
                                ...
                                ctx: { xhr: xhr, err: data.err, params: data.params }
                              });
                            });
                          });
...
function toRoute(path) {
  var paramRoutes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(paramRoutes), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function loadComponent(url, fn) {
  return loadJSON(url, function (err, data) {
    ...
    fn(null, { Component: Component, err: data.err, params: data.params });
  });
}
